  ...
  return (
    <>
      <div className='registration' >
        <p className='registration-heading'>Sign up to Graphico</p>
        <form>
          <label className='registration-label'>Name</label><br></br>
          <input type='text'></input><br></br>
          <label className='registration-label'>Username</label><br></br>
          <input type='text'></input><br></br>
          <label className='registration-label'>Email</label><br></br>
          <input type='text'></input><br></br>
          <label className='registration-label'>Password</label><br></br>
          <input type='Password'></input><br></br>
          <div className='checkbox'>
          <input type='checkbox' className='check'></input><p className='checkbox1'>I agree with Graphico's <a href='#'>
          Terms of Service, Privacy Policy</a>, and default <a href='#'>Notification Settings.</a></p></div>
          <button className='registration-button'>Sign up</button>
          <p className='registration-para1'>Already have an account? <a href='#'>Sign In</a></p>
          <p className='registration-para'>This site is protected by reCAPTCHA and the <a href='#'>
          Google Privacy Policy
          </a> and <a href='#'>Terms of Service apply.</a></p>
      </form>
  </div>
{/* ----------------------Login Page-------------------- */}
    <div className='Login-main'>
        <p className='Heading'>Log in to Graphico</p>
        <button className='google'><a href='#'><span >
...
</svg></span>Log in with Google</a></button>
        <h4 className='or'>Or</h4>
        <button className='Email'>Log in with Email</button>
        <p className='para'>By creating an account you agree with our <a href='#'>Terms of Service, Privacy Policy</a>,and our default <a href='#'>Notification Settings.</a></p>
        <p className='para1'>Already have an account?<a href='/Signin'> Sign in</a> </p>
    </div>
