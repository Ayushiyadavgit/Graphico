...
function Signin() {
  return (
    <div className='Signin-main'>
        ...
        <button className='signin-google'><a href='#'><span ><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none" role="img" class="icon ">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M8.99976 3.57955C10.3211 3.57955 11.5075 4.03364 12.4402 4.92545L15.0216 2.34409C13.4629 0.891818 11.4257 0 8.99976 0C5.48158 0 2.43794 2.01682 0.957031 4.95818L3.96385 7.29C4.67158 5.16273 6.65567 3.57955 8.99976 3.57955Z" fill="#EA4335"></path>
        ...
        <p className='signin-or'>Or Sign in with Email</p>
        <label className='form'>Username or Email</label><br></br>
        <input type='text' ></input><br></br>
        <label className='form'>Password</label><br></br>
        <input type='password' ></input>
        <button className='signin-submit'>Log in</button>
        <p className='signin-para'>Don't have an account?<a href='/Login'> Log in</a></p>
    </div>
  )
}
