...
import {FavoriteBorder, Visibility, Favorite, BookmarkBorder } from '@mui/icons-material';
      ...
      <div className='photo-outer'>
          <div className='photo'>
            ...
            <div className='photo-icon-box'>
              <span><FavoriteBorder className='photo-icon' /></span>
            ...
            <div className='photo-outerIcon'>
              ...
              <text className='visible'>1.5k</text></span>
            </div>
          </div>
      </div>
    </>
